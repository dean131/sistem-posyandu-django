...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('weight_for_age_0_24_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('weight_for_age_24_60_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('length_for_age_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('height_for_age_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('weight_for_length_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('weight_for_height_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('bmi_for_age_0_24_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
                ('bmi_for_age_24_60_chart', models.ImageField(blank=True, null=True, upload_to='growth_charts/')),
