...
from base.models import Child, ChildMeasurement, GrowthChart
...
class ChildInfoSerializer(ChildSerializer):
    ...
    def get_childmeasurements(self, obj):
        return ChildMeasurementSerializer(obj.childmeasurement_set.all(), many=True, context=self.context).data
